...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.vanilla_net =  self.VanillaNeuralNetwork(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        x = embedded + self.multi_headed_attention(self.layer_norm1(embedded))
        x = x + self.vanilla_net(self.layer_norm2(x))
